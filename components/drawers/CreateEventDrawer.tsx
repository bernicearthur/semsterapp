    ...
    <View style={[StyleSheet.absoluteFill, styles.container]}>
      ...
      <Animated.View style={[styles.drawer, drawerStyle, { backgroundColor: isDark ? '#0F172A' : '#F1F5F9' }]}>
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            {/* Event Image */}
            <TouchableOpacity style={[styles.imageUpload, { backgroundColor: isDark ? '#1E293B' : '#FFFFFF' }]}>
            ...
            <View style={styles.createButtonSection}>
              <TouchableOpacity 
                style={[
                  styles.createButton, 
                  { 
                    backgroundColor: title.trim() && description.trim() && selectedDate && selectedTime && selectedCategory ? '#3B82F6' : (isDark ? '#374151' : '#E5E7EB'),
                    opacity: title.trim() && description.trim() && selectedDate && selectedTime && selectedCategory ? 1 : 0.5
                  }
                ]}
                onPress={handleCreateEvent}
                disabled={!title.trim() || !description.trim() || !selectedDate || !selectedTime || !selectedCategory}
              >
