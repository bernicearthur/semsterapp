...
import { X, Video, Mic, MicOff, VideoOff, Camera, RotateCcw, Settings } from 'lucide-react-native';
import Animated, { 
  useAnimatedStyle, 
  withSpring,
  useSharedValue,
...
interface CameraPreviewDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  onJoinRoom: () => void;
  roomName?: string;
...
export function CameraPreviewDrawer({ isOpen, onClose, onJoinRoom, roomName }: CameraPreviewDrawerProps) {
