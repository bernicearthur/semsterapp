/*
  # Fix Signup and Profile Creation Issues

  1. Updates
    - Fix the handle_new_user trigger function to properly handle profile creation
    - Add missing policies for profile creation during signup
...
-- Make sure all necessary policies exist for profile creation
DO $$
BEGIN
