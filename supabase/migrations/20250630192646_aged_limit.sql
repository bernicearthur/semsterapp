/*
  # Fix Profile RLS Policies and Add Anon Access

  1. Updates
    - Add policy for anon users to insert profiles during signup
    - Fix policy for authenticated users to insert their own profile
    - Add policy for service role to insert profiles
    - Add policy for users to view profiles from their school
  
  2. Security
    - Ensure proper WITH CHECK expressions for INSERT policies
